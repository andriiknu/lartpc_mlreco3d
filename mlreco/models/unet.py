...
from mlreco.models.layers.common.unet_layers import UNet3Plus
...
class UNet_Chain(nn.Module):
    """
    UNet implementation. Typical configuration should look like:
    ...
    def __init__(self, cfg, name='uresnet_lonely'):
        super(UNet_Chain, self).__init__()
